...
When you run +piglet+ on a Piglet script the aliases in the output will be +relation_1+, +relation_2+, +relation_3+, and so on, instead of the names of the variables of the Piglet script.
...
Copyright (c) 2009 Theo Hultberg / Iconara. See LICENSE for details.
